                      ...
                      <Descriptions.Item span={3} label="Nombre">
                        ...
                        <Button
                          ...
                          onClick={async () => {
                            ...
                            const rq = await api.attendances
                              .create({
                                student: x.id,
                                date: date,
                                is_attend: true,
                              ...
                              .then((r) => {
                                notification.success({
                                  message: "ASISTENCIA CONFIRMADA CORRTAMENTE",
                                });
                              });
                          }}
                        >
                          Confirmar asistencía para hoy {date_f.getDate()}/
                          {date_f.getMonth() + 1}/{date_f.getFullYear()}
                        </Button>
                        <Button
                          type="primary"
                          size="small"
                          ...
                          onClick={async () => {
                            ...
                            const rq = await api.attendances
                              ...
                              .then((r) => {
                                notification.success({
                                  message:
                                    "INASISTENCIA CONFIRMADA CORRTAMENTE",
                                });
                              });
                          }}
                          danger
                        >
                          Confirmar inacistencía para hoy {date_f.getDate()}/
                          {date_f.getMonth() + 1}/{date_f.getFullYear()}
                        </Button>
                      </Descriptions.Item>
                    </>
